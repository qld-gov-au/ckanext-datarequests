...
import ckanext.datarequests.views as controller
import unittest
...
class ViewTest(unittest.TestCase):
    ...
    def test_new_post_content(self, authorized, validation_error):
        ...
        # Create the request
        request_helpers.request.POST = request_data = {
            'title': 'Example Title',
    ...
    def test_index_organization_user_dr(self, func, page, organization, user, expected_offset,
        ...
        if func == INDEX_FUNCTION:
            ...
            controller.helpers.url_for.assert_called_once_with(
                named_route='organization_datarequest.organization_datarequests', id=organization)
        elif func == USER_DATAREQUESTS_FUNCTION:
            controller.helpers.url_for.assert_called_once_with(
                named_route='user_datarequest.user_datarequests', id=user)
